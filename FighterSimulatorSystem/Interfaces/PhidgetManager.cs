    ...
    public class PhidgetManager
    {
        ...
        private void InitPhidgets()
        {
            try
            {
                ...
                // set custom chars
                lcd2.customCharacters[0].setCustomCharacter(491502, 1030144);   // open top
                lcd2.customCharacters[1].setCustomCharacter(479, 491502);       // open bottom

                lcd2.customCharacters[2].setCustomCharacter(915407, 981495);         // closed top 
                lcd2.customCharacters[3].setCustomCharacter(999163, 515965);         // closed bottom 
        ...
        private void UpdatePhidgets()
        {
            try
            {
                ...
                ////aoa
                //SetServoPos(advServo.servos[0], FSS.simconnect.simData.alpha,
                //    -25f, 25f, 500f, 2100f, false);

                ////vs
                //SetServoPos(advServo.servos[1], FSS.simconnect.simData.vt,
                //    -6000f, 6000f, 720f, 2500f, true);

                ////Oil
                //SetServoPos(advServo.servos[2], FSS.simconnect.simData.oilPressure,
                //    36f, 100f, 0f, 2730f, true);

                ////Nozzle Position
                //SetServoPos(advServo.servos[3], FSS.simconnect.simData.nozzlePos,
                //    15f, 100f, 0f, 2730f, true);

                ////RPM
                //SetServoPos(advServo.servos[4], FSS.simconnect.simData.rpm,
                ...
                //    FSS.simconnect.simData.ChaffCount,
                //    FSS.simconnect.simData.FlareCount);
                ...
                //// gear lights
                //ifk3.outputs[0] = (FSS.simconnect.simData.NoseGearPos > 0);
                //ifk3.outputs[2] = (FSS.simconnect.simData.LeftGearPos > 0);
                //ifk3.outputs[1] = (FSS.simconnect.simData.RightGearPos > 0);
